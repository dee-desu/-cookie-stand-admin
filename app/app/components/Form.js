    ...
    <div>
      <section className=" flex justify-center ">
        <form
          ...
          class="relative flex flex-col break-words mb-6 rounded-lg bg-white-400 rounded-3xl shadow-2xl w-4/5"
        >
          <div className="mt-7 mb-10 text-center border-b-2 ">
            <span className=" text-xl  text-gray-800 rounded-3xl border-1 border-gray-300 bg-blue-600 py-4 px-5 shadow-lg">
              Create Cookie Stand
            </span>
          </div>
